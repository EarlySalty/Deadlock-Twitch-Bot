...
| SAST | Semgrep OSS, bestehende Rust/Python/JavaScript/Security-Audit/OWASP/Actions-Regeln | Severity ERROR, `--error --strict`; Scanfehler werden nicht zu grün. |
...
- npm MODERATE/LOW, Trivy unter HIGH und Semgrep unter ERROR liegen unter der dokumentierten ersten Merge-Schwelle. zizmor läuft mit HIGH-Schwelle; ein grüner Lauf ist kein Beweis für null niedrigere Findings.
...
- Ein lokal begrenzter Clippy-Anlauf kompiliert Abhängigkeiten, ist aber kein vollständiger Erfolgsnachweis. Maßgeblich bleiben die vollständigen GitHub-Läufe inklusive DB und Scanner.
