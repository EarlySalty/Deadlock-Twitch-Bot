...
mod tests {
    ...
    async fn make_pool(schema: &str) -> Option<PgPool> {
        ...
        let pool = PgPoolOptions::new()
            ...
            .unwrap();
        for ddl in [
            // Das Kategorie-Gate haengt am Join auf social_media_category:
            // ohne Tabelle und ohne category_key liefert die Abfrage nichts,
            // und der Test wuerde eine intakte Pipeline als kaputt melden.
            ...
            "CREATE TABLE twitch_clips_social_media (id SERIAL PRIMARY KEY, clip_id TEXT, streamer_login TEXT, clip_title TEXT, duration_seconds DOUBLE PRECISION, game_name TEXT, upload_local_path TEXT, local_file_path TEXT, discarded_at TIMESTAMPTZ, category_key TEXT NOT NULL DEFAULT 'deadlock' REFERENCES social_media_category (category_key), created_at TIMESTAMPTZ DEFAULT NOW())",
