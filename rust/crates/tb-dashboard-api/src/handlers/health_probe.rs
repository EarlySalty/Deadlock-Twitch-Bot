...
pub async fn readyz_handler(
    ...
    readyz_response(startup_fingerprint(cache), internal_api_config(), oauth_configured()).await
}
...
mod tests {
    ...
    async fn json_response(
        ...
        let response = readyz_response(cache, internal_config, oauth_ready).await;
