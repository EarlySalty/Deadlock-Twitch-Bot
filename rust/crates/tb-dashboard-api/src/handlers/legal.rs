...
const DEFAULT_BODY_SICHERHEIT: &str = concat!(
    ...
    "<p>Melde gefundene L&#x00FC;cken vertraulich per E-Mail an ",
    "<a href='mailto:mail@earlysalty.com'>mail@earlysalty.com</a> oder via Discord an ",
    "<strong>earlysalty</strong> &#x2014; mit vollst&#x00E4;ndigem, reproduzierbarem Weg ",
    "(welche URL, Eingabe oder Request, was als Ergebnis sichtbar wurde).</p>"
);
