...
impl TrackedStore {
    ...
    pub async fn load(
        ...
        for row in rows {
            ...
            let is_inactivity_flagged = !is_archived
                && row
                    .operational_state
                    .as_deref()
    ...
    /// Partner, deren letzte bekannte Stream-Aktivität vor `cutoff` liegt.
    /// Nur aktive, nicht archivierte und noch nicht informativ markierte Partner
    /// mit vorhandener Historie.
