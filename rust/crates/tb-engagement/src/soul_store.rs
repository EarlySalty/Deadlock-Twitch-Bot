...
const SOUL_INTRO_ROOKIE: &str =
    "Noch was zu dir — aber WICHTIG: das hier ist dein Gedächtnis, nicht dein \
...
mod tests {
    ...
    fn rookie_fragment_laesst_hero_takes_weg() {
        ...
        assert_eq!(
            build_soul_fragment_for(Some("mag Haze"), &[], PersonaMode::Rookie),
            ""
        );
