...
- Der vorhandene DB-Test für die Discord-ID-Abfrage wurde ohne isolierte Test-DB nicht ausgeführt; ein DB-Lauf wird hier nicht behauptet. Ebenso wenig ein vollständiger Workspace- oder Live-Test.

Der frühere Zwischenstand dieses PR war zu Recht blockiert, weil der Poller nur Partner und ausdrücklich überwachte Konten erfasst. Der begrenzte On-Demand-Helix-Pfad schließt diese Lücke für verknüpfte Rolleninhaber; das unabhängige Review und das lokale Gate stehen noch aus. Discord muss nach Twitch ausgerollt werden, weil der Consumer ohne `last_seen_at` sicher gesperrt bleibt. Kein Merge oder Deploy aus diesem Branch.
