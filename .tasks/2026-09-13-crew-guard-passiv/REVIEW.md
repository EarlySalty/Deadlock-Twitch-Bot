...
Der zusätzliche Zustandsbefund beim tatsächlichen Merge ist ebenfalls korrigiert: Änderungen und Löschungen in allen vier Negativquellen berechnen den Widerruf unter derselben Registerzeilensperre neu. Erst wenn kein gültiger belastender Beleg verbleibt, werden Widerruf und alter Prüfzeitpunkt entfernt. Dies setzt ausdrücklich noch kein Vertrauen; der nächste Aufruf prüft wieder die normalen Historien-/Identitätskriterien. Unbekannte Konten bleiben unbekannt, andere bestätigte Belege verhindern jede Wiederqualifikation. Bestehende Scam-Undo-Handler ändern `action_taken` zu `overturned` und entfernen gegebenenfalls den zugehörigen Globalban; diese realen Schreibpfade werden ohne Polling oder Datenlöschung zur Vertrauensgewinnung erfasst. Tests decken tatsächliche UPDATE-/DELETE-Übergänge, mehrere Quellen, Partner/Historie, unbekannte Konten und gleichzeitigen Widerruf ab.

Die produktiven Schreibpfade für `tb_chat_autoban_log.source_path='scam'` stammen ausschließlich aus ConversationScam über die Standard-Ban-/Timeoutmethoden der ModerationEngine. Diese Auditkopie wird deshalb nicht als unabhängiger zweiter Negativbeleg gezählt: Maßgeblich bleibt der gespeicherte Scam-Verdict mit seinem Aufhebungsstatus. Spam-/Globalban-Auditaktionen und alle anderen gültigen Scam-Verdicts bleiben belastend. Beim echten Timeout-Undo kann die normale Neuprüfung damit erfolgen, obwohl das ursprüngliche Audit unverändert erhalten bleibt; ein weiterer gültiger Scam-Verdict verhindert sie weiterhin. Keine Auditzeile wird gelöscht oder anhand von Text/Zeit einem anderen Fall zugeordnet.
