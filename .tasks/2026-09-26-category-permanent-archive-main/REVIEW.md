...
Der fokussierte Rust-Check für Collector und Analytics ist grün. Dreizehn isolierte PostgreSQL-Tests für Archiv, Rollen, parallele Entfernung und Zustellung, Shared Chat, Ereigniszeit-Fallback und Reporting sowie vier Collector-Unit-Tests sind grün. Der Dashboard-Produktionsbuild, ESLint und drei Archivansicht-Tests sind grün. Das Schema-Snapshot wurde nur um die 15 Spalten der neuen Tabellen ergänzt; die frische Gesamtmigration bleibt CI-Gegenstand. Der erste Gate-Lauf fand ein Snapshot-Race und einen Dashboard-Timer-Nit; beides ist korrigiert. Ein unabhängiger Rust-Review fand die fehlende personenbezogene CLEARCHAT-Zielmarke; auch sie ist mit Spätzustellungs-Regression ergänzt. Ein weiterer Gate-Lauf fand, dass ein verspätet verarbeitetes CLEARCHAT gültige spätere Nachrichten entfernen würde; das Ende des Fensters folgt nun dem Twitch-Ereigniszeitpunkt, mit einem Vorher/Nachher-Regressionstest. Der finale Selbstreview-Gate und die unabhängige Abnahme werden auf dem neuen SHA wiederholt. Kein Merge oder Live-Deploy aus diesem Branch.
