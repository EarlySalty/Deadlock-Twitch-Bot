...
- `admin/legal_mixin.py` — `_DashboardLegalMixin`: Impressum/Datenschutz/AGB (`_render_legal_page`), Legal-Gate (`_legal_gate_cookie_secret`, `_legal_gate_configuration_state`). Siehe [LEGAL_ACCESS_GATE.md](../LEGAL_ACCESS_GATE.md).
