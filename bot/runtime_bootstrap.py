        ...
        async with self._runtime_lifecycle_lock():
            ...
            try:
                ...
                if cog.api:
                    ...
                    from bot.analytics.api_post_stream import (
                        _post_stream_reports_enabled,
                        backfill_post_stream_reports,
                        schedule_report_retry_job,
                    )
                    ...
                    if _post_stream_reports_enabled():
