...
from . import routes_self_explainer as _routes_self_explainer
...
class _DashboardRoutesMixin:
    ...
    def attach(self, app: web.Application) -> None:
        ...
        app.add_routes(_routes_self_explainer.build_route_defs(self))
        app.add_routes(
            [
                ...
                web.get("/twitch/auth/discord/link", self.discord_link_auth_login),
                web.get("/twitch/auth/discord/link/complete", self.discord_link_auth_complete),
