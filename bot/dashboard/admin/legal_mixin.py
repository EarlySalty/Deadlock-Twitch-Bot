...
class _DashboardLegalMixin:
    ...
    def _render_legal_gate_page(*, next_path: str, site_key: str) -> str:
        ...
        return (
            ...
            "<title>Zugang prüfen · EarlySalty</title>"
            ...
            ".spin{display:inline-block;width:16px;height:16px;border:2px solid #e2e8f0;"
            "border-top-color:#2563eb;border-radius:50%;animation:s 0.7s linear infinite;"
            "vertical-align:middle;margin-right:7px;}"
            "@keyframes s{to{transform:rotate(360deg)}}"
            "</style></head><body><div class='wrap'><div class='card'>"
            "<h1>Zugang wird geprüft</h1>"
            "<p><span class='spin'></span>Einen Moment …</p>"
            f"<form id='lgf' method='post' action='/twitch/legal/verify'>"
            ...
            "</form>"
            "<p class='hint'>Dieser Schutz verhindert den Zugriff durch KI-Crawler und Bots.</p>"
