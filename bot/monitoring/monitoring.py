...
class TwitchMonitoringMixin(_EventSubMixin, _ExpSessionsMixin, _SessionsMixin, _EmbedsMixin):
    ...
    def _partner_raid_score_refresh_interval_seconds(self) -> float:
        return partner_raid_score_refresh_interval_seconds(self)

    @staticmethod
    def _partner_raid_score_refresh_preferred_names(*, full_refresh: bool) -> tuple[str, ...]:
        return partner_raid_score_refresh_preferred_names(full_refresh=full_refresh)

    def _partner_raid_score_refresh_candidates(self) -> list[object]:
        return partner_raid_score_refresh_candidates(self)
    ...
    def _build_partner_raid_score_refresh_kwargs(
        ...
        *,
        ...
        return build_partner_raid_score_refresh_kwargs(
            func,
    ...
    async def _request_partner_raid_score_refresh(
        ...
        *,
        ...
        return await request_partner_raid_score_refresh(
            self,
            twitch_user_id=twitch_user_id,
            login=login,
            trigger=trigger,
    ...
    async def _run_partner_raid_score_refresh_task(
        ...
        *,
        ...
        await run_partner_raid_score_refresh_task(
            self,
            task_key=task_key,
            twitch_user_id=twitch_user_id,
            login=login,
    ...
    def _schedule_partner_raid_score_refresh(
        ...
        *,
        ...
        return schedule_partner_raid_score_refresh(
            self,
            twitch_user_id=twitch_user_id,
            login=login,
            trigger=trigger,
    ...
    def _schedule_partner_raid_score_refreshes(
        ...
        return schedule_partner_raid_score_refreshes(self, refreshes)

    def _maybe_schedule_partner_raid_score_reconciliation(self, *, trigger: str) -> bool:
        return maybe_schedule_partner_raid_score_reconciliation(self, trigger=trigger)
