...
const ENTRY_TEXTE: Record<string, string> = {
  ...
  match_status_unknown: 'Eigener Werbestart ausgesetzt, Matchstatus nicht bestätigt',
...
const GEGENWART_TEXTE: Record<string, string> = {
  ...
  in_match: 'Dein Match läuft. Der Bot nutzt verfügbare Twitch-Pausen und startet keine eigene Werbung.',
  match_status_unknown: 'Kein frischer Matchstatus. Eigene Werbestarts warten; der Bot nutzt verfügbare Twitch-Pausen.',
