  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <a
          href={invoiceHref}
          className="inline-flex flex-shrink-0 items-center justify-center gap-2 rounded-xl bg-[#00D9FF] px-6 py-3 text-sm font-semibold text-bg shadow-lg shadow-[#00D9FF]/20 transition-all duration-200 hover:bg-[#00D9FF]"
        >
