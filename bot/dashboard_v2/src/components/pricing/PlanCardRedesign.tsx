      ...
      >
        ...
        {isCurrent ? (
          ...
          <a
            ...
            className={`block text-center py-3 rounded-xl text-sm font-semibold transition-[background-color,border-color,color,box-shadow] duration-200 ${config.ctaStyle}`}
          >
            {plan.price_monthly === 0
              ? 'Kostenlos starten'
