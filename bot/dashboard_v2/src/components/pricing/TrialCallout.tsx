      ...
      <div className="relative rounded-2xl bg-card p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/20 text-white font-medium transition-[gap,background-color,border-color,transform] duration-200 hover:gap-3"
          >
            Mehr erfahren
