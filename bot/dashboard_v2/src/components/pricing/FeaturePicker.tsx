          ...
          return (
            ...
            >
              <button
                ...
                className={`w-full h-full rounded-2xl border p-5 text-left transition-[background-color,border-color,color,box-shadow,transform,translate,scale] duration-200 cursor-pointer ${
              ...
              <AnimatePresence>
                {tooltip === f.id && (
                  <motion.div
                    ...
                    className="absolute z-10 left-0 right-0 top-full mt-2 rounded-xl border border-border bg-[var(--color-popover)] p-3 shadow-xl"
                  >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <a
            ...
            className={`flex-shrink-0 px-6 py-3 rounded-xl text-sm font-semibold transition-[background-color,border-color,color,box-shadow,transform,translate,scale] duration-200 whitespace-nowrap ${
              isFree
