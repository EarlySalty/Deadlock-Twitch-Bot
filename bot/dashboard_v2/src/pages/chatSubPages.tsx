...
import { ChatAktivitaetContent, ChatTiefeContent, ChatTreueContent } from './chatAnalyticsContent';
import { useChatAnalyticsPage } from './useChatAnalyticsPage';
import { buildChatAnalyticsViewModel } from './chatAnalyticsViewModel';

interface ChatSubPageProps {
  streamer: string;
  days: TimeRange;
}

export function ChatTreue({ streamer, days }: ChatSubPageProps) {
  const {
    data,
    isLoading,
    coachingData,
...
export function ChatAktivitaet({ streamer, days }: ChatSubPageProps) {
  const {
    data,
    isLoading,
    coachingData,
...
export function ChatTiefe({ streamer, days }: ChatSubPageProps) {
  const {
    data,
    isLoading,
    coachingData,
