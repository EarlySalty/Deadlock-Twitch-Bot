...
export function CategoryCollector() {
  ...
  return <main className="mx-auto w-full max-w-[1500px] space-y-6 p-4 md:p-8">
    <header className="flex flex-wrap items-end justify-between gap-4">
      <div><p className="text-sm font-semibold uppercase tracking-widest text-primary">Twitch · Admin-Auswertung</p><h1 className="mt-2 text-3xl font-bold text-white">Deadlock weltweit</h1><p className="mt-3 max-w-3xl text-text-secondary">Admin-Auswertung der gesamten Twitch-Kategorie Deadlock: wann die Kategorie aktiv ist, welche Stream-Sprachen laufen und wie sich Zuschauer- und Chat-Aktivität entwickeln. Sprache ist kein Land und keine Zuschauer-Geolokation. Der Collector liest Chat anonym und sendet nichts.</p></div>
    ...
    {data && <>
      ...
      {!data.total_polls ? <section className="panel-card rounded-2xl p-8 text-text-secondary">Der Kategoriesammler liefert noch keine vollständige Messung. Die Ansicht ist damit noch nicht betriebsbereit; es werden keine historischen Daten vorgetäuscht.</section> : <>
