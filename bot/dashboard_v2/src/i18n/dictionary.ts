...
const EN: Record<string, string> = {
  ...
  "Deine Clip-Pipeline": "Your clip pipeline",
  "Auto-Pilot & Zeitplan": "Autopilot & schedule",
  "Templates & Layouts": "Templates & layouts",
  "Aus guten Momenten werden deine nächsten Posts.": "Turn great moments into your next posts.",
  "Clip hinzufügen": "Add clip",
  "Dein Posting-Rhythmus": "Your posting rhythm",
  "Freigaben und geplante Posts bleiben in der Pipeline sichtbar. Noch nicht gestartete Posts lassen sich stoppen.": "Approvals and scheduled posts remain visible in the pipeline. Posts that have not started yet can be stopped.",
  "Gameplay mit Hintergrund": "Gameplay with background",
  "Facecam & Gameplay": "Facecam & gameplay",
  "Split Screen": "Split screen",
  "Gespeichertes Layout öffnen": "Open saved layout",
  "Geplante Posts": "Scheduled posts",
  "Ein Post je Zielplattform": "One post per destination",
  "Clips durchsuchen": "Search clips",
  "Clips durchsuchen…": "Search clips…",
  "Plattform filtern": "Filter platform",
  "Plattform": "Platform",
  "Listenansicht": "List view",
  "Kartenansicht": "Card view",
  "Die Pipeline konnte nicht vollständig geladen werden.": "The full pipeline could not be loaded.",
  "{visible} von {total} Clips": "{visible} of {total} clips",
  "Zurück": "Previous",
  "Weiter": "Next",
  "Noch einen eigenen Clip auf Lager?": "Have another clip ready?",
  "MP4 hinzufügen": "Add MP4",
  "Clip-Status": "Clip status",
  "Neu": "New",
  "Geplant": "Scheduled",
  "Gepostet": "Posted",
  "Archiv": "Archive",
  "Clip ohne Titel": "Untitled clip",
  ...
  "Der Zeitplan wurde zwischenzeitlich geändert. Lade den aktuellen Stand mit Verwerfen.": "The schedule has changed. Use Discard to load the current version.",
  ...
  'Konten & Einstellungen': 'Accounts & settings',
  'Template & Layout': 'Template & layout',
  '9:16 Layout-Editor': '9:16 layout editor',
  'Lege den Standard-Ausschnitt für neue Clips fest. Einzelne Clips kannst du weiterhin separat anpassen.':
    'Set the default crop for new clips. You can still adjust individual clips separately.',
  'Repo-Default aktiv': 'Repo default active',
  'Streamer-Layout aktiv': 'Streamer layout active',
  'Layout für {streamer} speichern': 'Save layout for {streamer}',
  'Dieser Ausschnitt wird für neue Clips dieses Kanals verwendet.':
    'This crop is used for new clips from this channel.',
  '{count} Clips im Pool': '{count} clips in the pool',
  Puffer: 'Buffer',
  Manuell: 'Manual',
  '{count} Posts pro Woche': '{count} posts per week',
  'Geplante Clips': 'Scheduled clips',
  'mit mindestens einem Termin': 'with at least one scheduled slot',
  'Keine offenen Fehler': 'No open errors',
  'Bitte prüfen': 'Needs attention',
  'Manuellen MP4-Clip hochladen': 'Upload an MP4 clip',
  Öffnen: 'Open',
  'Clip-Queue': 'Clip queue',
  'Clips holen': 'Fetch clips',
  Performance: 'Performance',
  Auswertung: 'Analytics',
  'Social Studio': 'Social studio',
  'Repo-Default': 'Repo default',
  'Eigenes Layout': 'Custom layout',
  'Clips prüfen, Auto-Pilot steuern, Layout festlegen und Plattformen verwalten.':
    'Review clips, control auto-pilot, set the layout and manage platforms.',
  'Auswertung öffnen': 'Open analytics',
  'Clip-Layout': 'Clip layout',
  'Diese Anpassung gilt für diesen Clip.': 'This adjustment applies to this clip.',
  'Override entfernen': 'Remove override',
  'Das aktuelle Standard-Layout wird automatisch angewendet.':
    'The current default layout is applied automatically.',
  'Untertitel einbrennen': 'Burn in subtitles',
  'Brennt gesprochene Wörter als Untertitel ins Hochformat-Video.':
  ...
  Zielplattformen: 'Target platforms',
  'Metadaten bearbeiten': 'Edit metadata',
  'Layout anpassen': 'Adjust layout',
  'Vorschau neu rendern': 'Render preview again',
  'Vorschau rendern': 'Render preview',
  'Geplanten Post stoppen': 'Stop scheduled post',
  'Clip verwerfen': 'Discard clip',
  Arbeitsbereich: 'Workspace',
  'Kanal auswählen und verwalten': 'Select and manage a channel',
  'Streamer wählen': 'Select streamer',
  'Game mittig, Rand verschwommen': 'Game centered, blurred edges',
  'Blur-Rand': 'Blurred edges',
  'Blur-Rand: das Game liegt mittig, oben und unten ein verschwommener Rand. Ohne Cam.':
    'Blurred edges: the game stays centered with a blurred edge above and below. No camera.',
