...
export function InternalHomeLanding() {
  ...
  const mainNavItems: SidebarNavItem[] = [
    ...
    { href: analyticsTabHref('overview'), label: 'Overview', icon: BarChart3 },
    { href: analyticsTabHref('streams'), label: 'Streams', icon: Film },
    { href: analyticsTabHref('chat'), label: 'Chat', icon: MessageSquare },
  ];
