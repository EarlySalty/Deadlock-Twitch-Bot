...
const STATUS_STYLES: Record<string, string> = {
  ...
  idle: 'border-slate-500/40 bg-slate-800/45 text-slate-200',
  ...
  token_error: 'border-orange-400/35 bg-orange-500/15 text-orange-100',
  ...
  'reauth-needed': 'border-amber-200/65 bg-amber-500/16 text-amber-50 shadow-[0_0_0_1px_rgba(253,230,138,0.14)]',
  reauth_needed: 'border-amber-200/65 bg-amber-500/16 text-amber-50 shadow-[0_0_0_1px_rgba(253,230,138,0.14)]',
  ...
  blocked: 'border-rose-300/30 bg-slate-700/35 text-rose-100',
