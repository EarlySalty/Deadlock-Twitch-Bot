#!/usr/bin/env python3
"""
Social Media Phase 3 migration.

Enthaelt:
- Performance-Tracking fuer Social-Media-Clips
- Persistenz fuer LLM-Reports

Usage:
    python bot/migrations/social_media_phase3_analytics.py
    python bot/migrations/social_media_phase3_analytics.py --dsn "postgresql://..."
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Wendet die Social-Media-Phase-3-Migration an."
    )
    parser.add_argument(
        "--dsn",
...
def main() -> int:
    ...
    with psycopg.connect(dsn) as conn:
        print("Wende Social-Media-Phase-3-Migration an …")
        apply_phase3_analytics(conn)
        conn.commit()
        print("Fertig. Social-Media-Phase-3-Migration angewendet.")
    return 0
