## #223 — Werbefrei und Lurker-Steuer richten sich nach dem echten Planstand

**Ausgangslage:** Ob der Bot in einem Kanal Werbung schaltet oder die „Lurker-Steuer" (namentliche Erinnerung an stille Stammzuschauer) auslöst, hängt am gebuchten Plan des Streamers. Im neuen System wurde der Plan dafür nur grob über eine feste Namensliste geprüft: Ein einmal eingetragener Werbefrei- oder Analyse-Plan zählte dauerhaft — auch wenn er längst abgelaufen war. Umgekehrt konnte ein abgelaufener Plan, der Werbung abschaltet, die Werbung weiter blockieren, obwohl der Streamer gar nicht mehr dafür bezahlt. Außerdem fehlte der Chat-Befehl zum Abschalten der Lurker-Steuer komplett, und der Fehlertext beim Clip-Erstellen verwies auf einen Befehl, den es nicht mehr gibt.

**Was geändert wurde:** Werbe- und Lurker-Steuer-Entscheidungen laufen jetzt über die vollständige Plan-Auflösung — dieselbe, die auch Abrechnung und Dashboard nutzen. Sie berücksichtigt das Ablaufdatum eines manuell gesetzten Plans, löst Bundles und alte Plannamen sauber auf und zieht ein aktives Stripe-Abo als Rückfall heran. Der Chat-Befehl `!lurkersteuer_off` (mit `!lurkersteuer_aus` / `!lurker_tax_off`) ist neu gebaut. Der irreführende Verweis im Clip-Fehlertext ist entfernt.

**Wie es funktioniert:** Vor jeder Bot-Werbung wird der effektive Plan ermittelt. Ein abgelaufener Plan fällt automatisch auf „Gratis" zurück — abgelaufenes Werbefrei gibt die Werbung also wieder frei, und ein abgelaufener Bezahlplan schaltet die kostenpflichtige Lurker-Steuer nicht länger frei. Pläne, die Werbung bewusst abschalten, greifen dagegen weiterhin zuverlässig, solange sie gültig sind. `!lurkersteuer_off` darf nur der Streamer selbst nutzen, wirkt nur in registrierten Partnerkanälen und nur bei Plänen, die die Lurker-Steuer überhaupt enthalten; danach ist sie dauerhaft aus und lässt sich später im Abo-Bereich wieder einschalten (sie ist ohnehin standardmäßig deaktiviert). Der Clip-Fehlertext nennt jetzt schlicht, dass der Streamer den Bot einmal autorisieren muss.
